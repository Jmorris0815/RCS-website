...
neighborhoods:
  ...
  - "Burnley"
  - "Mountain Track Estates"
  - "Greenwood / Greenwood Farms"
  - "Properties along Route 33 and Route 20"
treeSpecies:
  - "White oak"
  - "Black walnut"
  - "Eastern red cedar"
...
commonProblems:
  - problem: "Walnut hulls clogging downspouts in October"
    cause: "Black walnut trees throw heavy hulls in fall that no foam or screen guard can handle"
    recommendation: "Xtreme stainless micro-mesh handles walnut hulls; keep downspout outlets oversized to 3x4"
  - problem: "Wind-driven debris on exposed ridge homes"
    cause: "Open ridge lots above 600 ft pick up debris from a quarter-mile away during Blue Ridge thunderstorms"
    recommendation: "Hidden hangers at 18-inch spacing instead of standard 24, plus end caps with riveted seams"
  - problem: "Cedar shake debris from older barn-roof structures"
    cause: "A lot of Barboursville's outbuildings still have cedar shake that breaks down each year and washes onto adjacent gutters"
    recommendation: "Annual inspections after major storms; consider rerouting downspouts away from outbuilding catch zones"
  - problem: "Long horizontal runs sagging on barn-style outbuildings"
...
seoTitle: "Barboursville VA Gutters | Right Choice Seamless Gutters"
seoDescription: "Right Choice Seamless Gutters is based in Barboursville, VA. Same-day estimates for installs, cleanings, and Leaf Solution gutter guards in our home village and surrounding Orange County."
---
