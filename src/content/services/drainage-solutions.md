...
tagline: "Where gutter water actually goes. Buried discharge, French drains, pop-up emitters."
description: "Underground downspout drainage, French drain installation, pop-up emitters, and full foundation drainage planning across Central Virginia. Splash blocks alone don't solve real water problems."
featuredOrder: 7
faqs:
  - question: "What's wrong with splash blocks?"
    answer: "Nothing. For the right situation. Splash blocks work fine on level ground with sandy soil and modest roof areas. They fail on heavy clay (most of Central VA), on slopes, on roofs that drain large catchment areas to one corner, and on properties where the ground is already saturated. We see splash-block failures every week in our service area."
  - question: "What's a buried discharge line?"
  ...
  - question: "What's a pop-up emitter?"
    answer: "A small plastic head at the end of a buried discharge line. When water flow comes through, the head pops up to release water above the lawn surface. When flow stops, the head closes flush with the lawn. Used when you can't slope a buried line all the way to a daylight discharge."
  - question: "Do I need a French drain?"
    answer: "A French drain is for groundwater management. Collecting and redirecting water that's saturating soil. Not for downspout discharge. Sometimes both are needed and they get combined. We assess and recommend; we don't push products you don't need."
  - question: "What about basement waterproofing?"
    answer: "Basement waterproofing is a different specialty. Our work stops at proper exterior drainage. Getting roof water and surface water away from the foundation. Once water is inside the foundation wall, that's a basement-waterproofing contractor's job. We'll refer you to companies we trust for that work."
seoTitle: "Foundation Drainage & Underground Downspouts Central VA | RCS Gutters"
seoDescription: "Buried downspout discharge, pop-up emitters, French drains, and proper foundation drainage planning across Central Virginia. Stop the water at the gutter. Get it where it belongs."
---
...
- [Seamless gutter installation](/services/seamless-gutter-installation/). Frequently combined with drainage work.
- [Gutter cleaning](/services/gutter-cleaning/). Sometimes the cleaning fixes the problem; sometimes it reveals the drainage issue.
- [Commercial gutters](/services/commercial-gutters/). Commercial work almost always includes drainage planning.
